...
let i = 0;
let prev_cdr: SNode|undefined;

function test_draw_classes() {
    const sconstraint = new TextNode("SConstraint");
    const field_constraint = new TextNode("FieldConstraint");
    const vertical_compound_constraint =
          new TextNode("VerticalCompoundConstraint");
    const horizontal_compound_constraint =
          new TextNode("HorizontalCompoundConstraint");
    const vertical_constraint =
          new TextNode("VerticalConstraint");
    const horizontal_constraint =
          new TextNode("HorizontalConstraint");
